...
const propertySchema = new Schema(
  {
    ...
    status: { type: String },
    objectTags: [{ type: Schema.Types.Mixed }],
    location: { type: Schema.Types.Mixed },
    physicalDetails: { type: Schema.Types.Mixed },
    financials: { type: Schema.Types.Mixed },
    flags: { type: Schema.Types.Mixed },
    mlsData: { type: Schema.Types.Mixed },
    legalInfo: { type: Schema.Types.Mixed },
    unitMixes: [{ type: Schema.Types.Mixed }],
    saleHistory: [{ type: Schema.Types.Mixed }],
    mortgages: [{ type: Schema.Types.Mixed }],
    demographics: { type: Schema.Types.Mixed },
    foreclosureInfo: [{ type: Schema.Types.Mixed }],
    mlsHistory: [{ type: Schema.Types.Mixed }],
    linkedProperties: [{ type: Schema.Types.Mixed }],
